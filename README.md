...
Built for the National Solana Hackathon (Decentrathon), Case 2.

- **Mukhan** — Rust, Solana program, frontend wallet integration
- **Backend team** — Go API, GitHub integration, AI allocation engine
- **Kirill** — Go backend, API design, orchestration
